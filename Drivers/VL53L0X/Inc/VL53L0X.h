...
#ifndef VL53L0X_INC_VL53L0X_H_
#define VL53L0X_INC_VL53L0X_H_
...
void VL53L0X_setAddress(VL53L0X* dev, uint8_t new_addr);
...
uint32_t VL53L0X_readReg32Bit(VL53L0X* dev, uint8_t reg);
...
float VL53L0X_getSignalRateLimit(VL53L0X* dev);
...
void VL53L0X_stopContinuous(VL53L0X* dev);

uint16_t VL53L0X_readRangeContinuousMillimeters(VL53L0X* dev);

uint16_t VL53L0X_readRangeSingleMillimeters(VL53L0X* dev);
